...
import './staff-form-handBook.css'; // Import the CSS file for additional styling if needed

const StaffFormHandBook = () => {
  ...
  const handleBack = () => {
      ...
      navigate(`/admin-registered/${userId}`);  // This will take the user one step back in history
  };
  ...
  return (
    <>
        ...
        {/* <div className="HandBook-acknowledgment-signature">
          ...
          <form className="HandBook-acknowledgment-signature">
            <div className="signature-row">
      ...
      <p><b>Instructions to employee:</b> Please place a check mark beside each item when fully oriented. Indicate below, the items you have not been fully oriented on.</p>
          ...
          <div className="p-6 text-center">
                ...
                <p className="mb-4">
                Thank you taking your time to read!:
                </p>
                {/* <a
                    href="employee"
...
export default StaffFormHandBook;
