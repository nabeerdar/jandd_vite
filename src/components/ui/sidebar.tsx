...
const SidebarTrigger = React.forwardRef<
  ...
  React.ComponentProps<typeof Button> &  { toggleSidebarParent: () => void }
>(({ toggleSidebarParent, className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar(); // Call the function passed down via props to toggle the sidebar
        toggleSidebarParent()
      }}
      {...props}
    >
