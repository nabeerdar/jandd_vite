...
<div className="HandBook-acknowledgment-signature">
  <div className="signature-row">
    <label htmlFor="employee-name" className="Hand-bold">EMPLOYEE’S NAME:</label>
    <input id="employee-name" type="text" placeholder="Please Print" className="employee-input"/>
  </div>

  <div className="signature-row">
    <label htmlFor="employee-signature" className="Hand-bold">EMPLOYEE’S SIGNATURE:</label>
    <input id="employee-signature" type="text" placeholder="Signature" className="employee-input"/>
    <label htmlFor="signature-date" className="Hand-bold date-label">DATE:</label>
    <input id="signature-date" type="date" className="employee-input date-input"/>
  </div>

  <div className="signature-row">
    <label htmlFor="representative-name" className="Hand-bold">J AND D HEALTHCARE REPRESENTATIVE:</label>
    <input id="representative-name" type="text" placeholder="Name" className="employee-input"/>
    <label htmlFor="representative-date" className="Hand-bold date-label">DATE:</label>
    <input id="representative-date" type="date" className="employee-input date-input"/>
  </div>
</div>
